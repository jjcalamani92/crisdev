...
const Footer = () => {
    ...
    return (
        <Main>
        <div className="">
            <footer id="footer" className=" dark:bg-gray-900 pt-24">
                ...
                <div className="py-16 flex flex-col justify-center items-center">
                    ...
                    <p className="mt-6 text-xs lg:text-sm leading-none text-gray-900 dark:text-gray-50">2022 crisDev. All Rights Reserved.</p>
                </div>
            </footer>
        </div>
        </Main>
