    ...
    return (
        ...
        <div className=" px-6 py-16 text-center">
            <div className="max-w-xl mx-auto">
                <h1 className="text-4xl lg:text-7xl text-center font-bold text-gray-800 leading-normal">La libertad de crear el sitio web <span className="text-orange-500">e-commerce</span>  que desea</h1>
