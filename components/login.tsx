    ...
    <div className="h-screen w-screen grid content-center">
      <div className="flex justify-center">
        ...
        <div className="bg-white shadow-lg rounded lg:w-1/4 w-50 p-10">
          ...
          <div className="mt-8">
            <button role="button" aria-label="create my account" className="focus:ring-2 focus:ring-offset-2 focus:ring-orange-500 text-sm font-semibold leading-none text-white focus:outline-none bg-orange-500 border rounded hover:bg-orange-600 py-4 w-full">
              Create my account
            </button>
          </div>
        </div>
